...
if [ "y" == "$strship" ]; then
    ...
    if [ -d ~/.bash_aliases.d/ ]; then
        if test -f aliases/.bash_aliases.d/starship.sh; then
            ...
            curl -o ~/.bash_aliases.d/starship.sh https://raw.githubusercontent.com/water-carrier3/dotfiles/main/aliases/.bash_aliases.d/starship.sh
        fi
...
if [ "y" == "$strship" ]; then
    ...
    if [ -d /root/.bash_aliases.d/ ]; then
        if test -f aliases/.bash_aliases.d/starship.sh; then
            ...
            sudo curl -o /root/.bash_aliases.d/starship.sh https://raw.githubusercontent.com/water-carrier3/dotfiles/main/aliases/.bash_aliases.d/starship.sh
        fi 
...
if ! test -f aliases/.bash_aliases.d/starship.sh; then
     eval "$(curl -fsSL https://raw.githubusercontent.com/water-carrier3/dotfiles/main/aliases/.bash_aliases.d/starship.sh)" 
else
