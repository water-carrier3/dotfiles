...
if [ ! -f ~/.bash_completion ]; then
    if ! test -f completions/.bash_completion; then
        curl -o ~/.bash_completion https://raw.githubusercontent.com/water-carrier3/dotfiles/main/completions/.bash_completion
    else
...
if ! sudo test -f /root/.bash_completion; then
    ...
    if [ ! -f /root/.bash_completion ]; then
        if ! test -f completions/.bash_completion; then
            sudo curl -o /root/.bash_completion https://raw.githubusercontent.com/water-carrier3/dotfiles/main/completions/.bash_completion 
        else
