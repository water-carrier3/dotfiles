...
if [ ! -f ~/.bash_aliases ]; then
    if ! test -f aliases/.bash_aliases; then
        curl -o ~/.bash_aliases https://raw.githubusercontent.com/water-carrier3/dotfiles/main/aliases/.bash_aliases  
    else
...
if ! test -f ~/.bash_aliases.d/check_system.sh; then
    if ! test -f checks/check_system.sh; then
        curl -o ~/.bash_aliases.d/check_system.sh https://raw.githubusercontent.com/water-carrier3/dotfiles/main/checks/check_system.sh  
    else
...
if ! test -f ~/.bash_aliases.d/bash.sh; then
    if ! test -f aliases/.bash_aliases.d/bash.sh; then
        curl -o ~/.bash_aliases.d/bash.sh https://raw.githubusercontent.com/water-carrier3/dotfiles/main/aliases/.bash_aliases.d/bash.sh  
    else
...
if ! test -f ~/.bash_aliases.d/00-rlwrap_scripts.sh; then 
    if ! test -f aliases/.bash_aliases.d/00-rlwrap_scripts.sh; then
        curl -o ~/.bash_aliases.d/00-rlwrap_scripts.sh https://raw.githubusercontent.com/water-carrier3/dotfiles/main/aliases/.bash_aliases.d/00-rlwrap_scripts.sh  
    else
...
if [ ! -f ~/.bash_completion ]; then
    if ! test -f completions/.bash_completion; then
        curl -o ~/.bash_aliases https://raw.githubusercontent.com/water-carrier3/dotfiles/main/completions/.bash_completion
    else
...
if [ ! -f ~/.keybinds ]; then
    if ! test -f keybinds/.keybinds; then
        curl -o ~/.bash_aliases https://raw.githubusercontent.com/water-carrier3/dotfiles/main/keybinds/.keybinds
    else
...
if ! sudo test -f /root/.bash_completion; then
    ...
    if [ ! -f /root/.bash_completion ]; then
        if ! test -f completions/.bash_completion; then
            sudo curl -o /root/.bash_aliases https://raw.githubusercontent.com/water-carrier3/dotfiles/main/completions/.bash_completion 
        else
...
if ! sudo test -f /root/.keybinds; then
    ...
    if [ ! -f /root/.keybinds ]; then
        if ! test -f keybinds/.keybinds; then
            sudo curl -o /root/.bash_aliases https://raw.githubusercontent.com/water-carrier3/dotfiles/main/keybinds/.keybinds 
        else
