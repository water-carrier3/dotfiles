...
if ! test -d kitty/.config/kitty; then
    ...
    chmod u+x "$tmpfile"
    eval $tmpfile https://github.com/water-carrier3/dotfiles/tree/main/kitty/.config/kitty $tmpdir
    wget -P $tmpdir https://raw.githubusercontent.com/water-carrier3/dotfiles/main/kitty/.bash_aliases.d/kitty.sh 
