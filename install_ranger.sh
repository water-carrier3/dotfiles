...
if [ -d ~/.bash_aliases.d/ ]; then
    if ! test -f ranger/.bash_aliases.d/ranger.sh ; then
        curl -o ~/.bash_aliases.d/ranger.sh https://raw.githubusercontent.com/water-carrier3/dotfiles/main/ranger/.bash_aliases.d/ranger.sh
    else
...
if ! [ -d ranger/.config/ranger/ ]; then
    ...
    curl -o $tmpdir/rc.conf https://raw.githubusercontent.com/water-carrier3/dotfiles/main/ranger/.config/ranger/rc.conf
    curl -o $tmpdir/scope.sh https://raw.githubusercontent.com/water-carrier3/dotfiles/main/ranger/.config/ranger/scope.sh
    curl -o $tmpdir/rifle.conf https://raw.githubusercontent.com/water-carrier3/dotfiles/main/ranger/.config/ranger/rifle.conf
    dir=$tmpdir
else
        ...
        if test "$distro" == "Arch" || test $distro == "Manjaro" ;then
            ...
            if [ -z $nrdfnts ] || [ "Y" == $nrdfnts ] || [ $nrdfnts == "y" ]; then
                if ! test -f ./install_nerdfonts.sh; then
                    eval "$(curl -fsSL https://raw.githubusercontent.com/water-carrier3/dotfiles/main/install_nerdfonts.sh)" 
                else
