...
#        eval "$(curl -fsSL https://raw.githubusercontent.com/water-carrier3/dotfiles/main/aliases/.bash_aliases.d/install_fzf.sh)" 
#    else
#        ./install_fzf.sh
#    fi 
#fi
   ...
   if ! [ -x "$(command -v git)" ]; then
        ...
        if test "$gitpgr" == "y"; then
            ...
            if test $pager == "bat"; then
                if ! test -f install_bat.sh; then
                    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/water-carrier3/dotfiles/main/install_bat.sh)"
                else
                   ./install_bat.sh
                fi
                ...
                if ! test -f install_moar.sh; then
                    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/water-carrier3/dotfiles/main/install_moar.sh)"
                else
                   ./install_moar.sh
                fi
            elif test $pager == "most"; then
                if ! test -f install_most.sh; then
                    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/water-carrier3/dotfiles/main/install_most.sh)"
                else
                   ./install_most.sh
                fi
               ...
               if ! test -f install_nvimpager.sh; then
                    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/water-carrier3/dotfiles/main/install_nvimpager.sh)"
                else
            ...
            if test "$distro" == "Arch" || test "$distro" == "Manjaro"; then
                if test $pager == "diff-so-fancy"; then
                    ...
                    if ! test -z $upg_pipx && ! test -f install_pipx.sh; then
                        /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/water-carrier3/dotfiles/main/install_pipx.sh)"
                    else
                        ./install_pipx.sh
                    fi
    ...
    if [ "y" == "$gitign" ]; then
        if ! test -f install_gitignore.sh; then
            /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/water-carrier3/dotfiles/main/install_gitignore.sh)"
        else
    ...
    if [ "$gitals" == "y" ]; then
        ...
        if ! test -f aliases/.bash_aliases.d/git.sh; then
            curl -o ~/.bash_aliases.d/git.sh https://raw.githubusercontent.com/water-carrier3/dotfiles/main/aliases/.bash_aliases.d/git.sh  
        else
