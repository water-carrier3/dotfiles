...
```
eval "$(curl -fsSL https://raw.githubusercontent.com/water-carrier3/dotfiles/main/install.sh)"
```
...
&nbsp;&nbsp;&nbsp;- Vim-tmux-kitty-navigator: https://github.com/water-carrier3/vim-tmux-kitty-navigator  
